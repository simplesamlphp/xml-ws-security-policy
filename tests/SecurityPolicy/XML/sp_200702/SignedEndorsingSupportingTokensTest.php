...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SignedEndorsingSupportingTokens;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SignedEndorsingSupportingTokensTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(SignedEndorsingSupportingTokens::class)]
...
final class SignedEndorsingSupportingTokensTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/SignedEndorsingSupportingTokens.xml',
        );
