...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RecipientEncryptionToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RecipientEncryptionTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RecipientEncryptionToken::class)]
...
final class RecipientEncryptionTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RecipientEncryptionToken.xml',
        );
