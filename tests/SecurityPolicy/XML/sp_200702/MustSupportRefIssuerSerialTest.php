...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefIssuerSerial;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefIssuerSerialTest
 *
...
final class MustSupportRefIssuerSerialTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/MustSupportRefIssuerSerial.xml',
        );
    }
}
