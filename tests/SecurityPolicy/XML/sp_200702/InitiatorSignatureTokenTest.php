...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\InitiatorSignatureToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\InitiatorSignatureTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(InitiatorSignatureToken::class)]
...
final class InitiatorSignatureTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/InitiatorSignatureToken.xml',
        );
