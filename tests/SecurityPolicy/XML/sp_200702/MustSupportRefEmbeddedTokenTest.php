...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefEmbeddedToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefEmbeddedTokenTest
 *
...
final class MustSupportRefEmbeddedTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/MustSupportRefEmbeddedToken.xml',
        );
    }
}
