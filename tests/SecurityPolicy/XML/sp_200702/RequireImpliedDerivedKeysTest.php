...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireImpliedDerivedKeys;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireImpliedDerivedKeysTest
 *
...
final class RequireImpliedDerivedKeysTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireImpliedDerivedKeys.xml',
        );
    }
}
