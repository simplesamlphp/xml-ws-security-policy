...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\EndorsingEncryptedSupportingTokens;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\EndorsingEncryptedSupportingTokensTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(EndorsingEncryptedSupportingTokens::class)]
...
final class EndorsingEncryptedSupportingTokensTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/EndorsingEncryptedSupportingTokens.xml',
        );
