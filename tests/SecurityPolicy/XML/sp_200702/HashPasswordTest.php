...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HashPassword;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HashPasswordTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(HashPassword::class)]
...
final class HashPasswordTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/HashPassword.xml',
        );
    }
}
