...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireExplicitDerivedKeys;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireExplicitDerivedKeysTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireExplicitDerivedKeys::class)]
...
final class RequireExplicitDerivedKeysTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireExplicitDerivedKeys.xml',
        );
    }
}
