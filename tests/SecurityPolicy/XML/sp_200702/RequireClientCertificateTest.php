...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireClientCertificate;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireClientCertificateTest
 *
...
final class RequireClientCertificateTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireClientCertificate.xml',
        );
    }
}
