...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\EncryptBeforeSigning;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\EncryptBeforeSigningTest
 *
...
final class EncryptBeforeSigningTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/EncryptBeforeSigning.xml',
        );
    }
}
