...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\NoPasswordTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(NoPassword::class)]
...
final class NoPasswordTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/NoPassword.xml',
        );
    }
}
