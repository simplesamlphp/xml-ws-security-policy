...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HttpBasicAuthentication;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HttpBasicAuthenticationTestTest
 *
...
final class HttpBasicAuthenticationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/HttpBasicAuthentication.xml',
        );
    }
}
