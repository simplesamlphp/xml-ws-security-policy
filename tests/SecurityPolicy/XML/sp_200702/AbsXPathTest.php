...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\AbsXPath;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\AbsXPathTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(AbsXPath::class)]
...
final class AbsXPathTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/AbsXPath.xml',
        );
    }
}
