...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SC13SecurityContextToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SC13SecurityContextTokenTest
 *
...
final class SC13SecurityContextTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/SC13SecurityContextToken.xml',
        );
    }
}
