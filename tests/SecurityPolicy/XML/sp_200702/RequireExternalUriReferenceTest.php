...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireExternalUriReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireExternalUriReferenceTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireExternalUriReference::class)]
...
final class RequireExternalUriReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireExternalUriReference.xml',
        );
    }
}
