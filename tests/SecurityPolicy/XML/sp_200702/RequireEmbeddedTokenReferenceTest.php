...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireEmbeddedTokenReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireEmbeddedTokenReferenceTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireEmbeddedTokenReference::class)]
...
final class RequireEmbeddedTokenReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireEmbeddedTokenReference.xml',
        );
    }
}
