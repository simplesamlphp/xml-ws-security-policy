...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\TripleDesSha256Rsa15;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\TripleDesSha256Rsa15Test
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(TripleDesSha256Rsa15::class)]
...
final class TripleDesSha256Rsa15Test extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/TripleDesSha256Rsa15.xml',
        );
    }
}
