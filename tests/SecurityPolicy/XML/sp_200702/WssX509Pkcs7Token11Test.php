...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\WssX509Pkcs7Token11;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\WssX509Pkcs7Token11Test
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(WssX509Pkcs7Token11::class)]
...
final class WssX509Pkcs7Token11Test extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/WssX509Pkcs7Token11.xml',
        );
    }
}
