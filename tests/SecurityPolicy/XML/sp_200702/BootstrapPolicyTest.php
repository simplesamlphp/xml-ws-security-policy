...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\BootstrapPolicy;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\BootstrapPolicyTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(BootstrapPolicy::class)]
...
final class BootstrapPolicyTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/BootstrapPolicy.xml',
        );
