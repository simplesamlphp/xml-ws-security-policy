...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HttpDigestAuthentication;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\HttpDigestAuthenticationTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(HttpDigestAuthentication::class)]
...
final class HttpDigestAuthenticationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/HttpDigestAuthentication.xml',
        );
    }
}
