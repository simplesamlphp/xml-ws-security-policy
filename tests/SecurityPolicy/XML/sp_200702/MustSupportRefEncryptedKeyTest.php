...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefEncryptedKey;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportRefEncryptedKeyTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(MustSupportRefEncryptedKey::class)]
...
final class MustSupportRefEncryptedKeyTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/MustSupportRefEncryptedKey.xml',
        );
    }
}
