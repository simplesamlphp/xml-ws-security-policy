...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireRequestSecurityTokenCollection;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireRequestSecurityTokenCollectionTest
 *
...
final class RequireRequestSecurityTokenCollectionTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireRequestSecurityTokenCollection.xml',
        );
    }
}
