...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireAppliesTo;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireAppliesToTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireAppliesTo::class)]
...
final class RequireAppliesToTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireAppliesTo.xml',
        );
    }
}
