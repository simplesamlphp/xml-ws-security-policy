...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireSignatureConfirmation;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireSignatureConfirmationTest
 *
...
final class RequireSignatureConfirmationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireSignatureConfirmation.xml',
        );
    }
}
