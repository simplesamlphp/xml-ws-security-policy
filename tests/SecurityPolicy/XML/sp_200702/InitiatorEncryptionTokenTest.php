...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\InitiatorEncryptionToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\InitiatorEncryptionTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(InitiatorEncryptionToken::class)]
...
final class InitiatorEncryptionTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/InitiatorEncryptionToken.xml',
        );
