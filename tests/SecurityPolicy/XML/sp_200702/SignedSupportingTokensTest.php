...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SignedSupportingTokens;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\SignedSupportingTokensTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(SignedSupportingTokens::class)]
...
final class SignedSupportingTokensTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/SignedSupportingTokens.xml',
        );
