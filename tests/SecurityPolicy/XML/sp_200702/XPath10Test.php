...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\XPath10;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\XPath10Test
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(XPath10::class)]
...
final class XPath10Test extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/XPath10.xml',
        );
    }
}
