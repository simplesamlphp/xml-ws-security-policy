...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportClientChallenge;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\MustSupportClientChallengeTest
 *
...
final class MustSupportClientChallengeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/MustSupportClientChallenge.xml',
        );
    }
}
