...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireIssuerSerialReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200702\RequireIssuerSerialReferenceTest
 *
...
final class RequireIssuerSerialReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200702/RequireIssuerSerialReference.xml',
        );
    }
}
