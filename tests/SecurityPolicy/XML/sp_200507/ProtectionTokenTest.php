...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\ProtectionToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\ProtectionTokenTest
 *
...
final class ProtectionTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/ProtectionToken.xml',
        );
