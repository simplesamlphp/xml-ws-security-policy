...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\SupportingTokens;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\SupportingTokensTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(SupportingTokens::class)]
...
final class SupportingTokensTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/SupportingTokens.xml',
        );
