...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireEmbeddedTokenReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireEmbeddedTokenReferenceTest
 *
...
final class RequireEmbeddedTokenReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireEmbeddedTokenReference.xml',
        );
    }
}
