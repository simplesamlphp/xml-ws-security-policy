...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\TripleDesRsa15;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\TripleDesRsa15Test
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(TripleDesRsa15::class)]
...
final class TripleDesRsa15Test extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/TripleDesRsa15.xml',
        );
    }
}
