...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\OnlySignEntireHeadersAndBody;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\OnlySignEntireHeadersAndBodyTest
 *
...
final class OnlySignEntireHeadersAndBodyTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/OnlySignEntireHeadersAndBody.xml',
        );
    }
}
