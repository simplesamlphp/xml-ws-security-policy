...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireClientEntropyTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireClientEntropy::class)]
...
final class RequireClientEntropyTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireClientEntropy.xml',
        );
    }
}
