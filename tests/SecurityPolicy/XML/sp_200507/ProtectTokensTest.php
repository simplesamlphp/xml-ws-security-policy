...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\ProtectTokens;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\ProtectTokensTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(ProtectTokens::class)]
...
final class ProtectTokensTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/ProtectTokens.xml',
        );
    }
}
