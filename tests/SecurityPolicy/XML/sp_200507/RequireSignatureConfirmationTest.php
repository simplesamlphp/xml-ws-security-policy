...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireSignatureConfirmation;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireSignatureConfirmationTest
 *
...
final class RequireSignatureConfirmationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireSignatureConfirmation.xml',
        );
    }
}
