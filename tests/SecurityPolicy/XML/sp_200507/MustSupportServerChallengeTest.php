...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportServerChallenge;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportServerChallengeTest
 *
...
final class MustSupportServerChallengeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportServerChallenge.xml',
        );
    }
}
