...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\TransportBindingTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(TransportBinding::class)]
...
final class TransportBindingTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/TransportBinding.xml',
        );
