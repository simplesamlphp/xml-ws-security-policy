...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\InitiatorToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\InitiatorTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(InitiatorToken::class)]
...
final class InitiatorTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/InitiatorToken.xml',
        );
