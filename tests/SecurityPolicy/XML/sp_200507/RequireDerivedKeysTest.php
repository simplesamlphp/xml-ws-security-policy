...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireDerivedKeys;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireDerivedKeysTest
 *
...
final class RequireDerivedKeysTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireDerivedKeys.xml',
        );
    }
}
