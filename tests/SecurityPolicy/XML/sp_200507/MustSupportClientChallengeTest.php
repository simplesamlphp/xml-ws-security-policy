...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportClientChallenge;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportClientChallengeTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(MustSupportClientChallenge::class)]
...
final class MustSupportClientChallengeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportClientChallenge.xml',
        );
    }
}
