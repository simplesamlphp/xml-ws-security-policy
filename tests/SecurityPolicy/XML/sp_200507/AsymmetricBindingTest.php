...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\AsymmetricBinding;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\AsymmetricBindingTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(AsymmetricBinding::class)]
...
final class AsymmetricBindingTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/AsymmetricBinding.xml',
        );
