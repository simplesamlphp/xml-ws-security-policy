...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireExternalUriReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireExternalUriReferenceTest
 *
...
final class RequireExternalUriReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireExternalUriReference.xml',
        );
    }
}
