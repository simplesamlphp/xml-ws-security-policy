...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefIssuerSerial;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefIssuerSerialTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(MustSupportRefIssuerSerial::class)]
...
final class MustSupportRefIssuerSerialTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportRefIssuerSerial.xml',
        );
    }
}
