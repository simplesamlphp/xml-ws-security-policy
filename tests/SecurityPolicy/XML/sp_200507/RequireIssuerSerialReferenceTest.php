...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireIssuerSerialReference;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireIssuerSerialReferenceTest
 *
...
final class RequireIssuerSerialReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireIssuerSerialReference.xml',
        );
    }
}
