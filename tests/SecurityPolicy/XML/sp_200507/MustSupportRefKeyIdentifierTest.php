...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefKeyIdentifier;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefKeyIdentifierTest
 *
...
final class MustSupportRefKeyIdentifierTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportRefKeyIdentifier.xml',
        );
    }
}
