...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefEmbeddedToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefEmbeddedTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(MustSupportRefEmbeddedToken::class)]
...
final class MustSupportRefEmbeddedTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportRefEmbeddedToken.xml',
        );
    }
}
