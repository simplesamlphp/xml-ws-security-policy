...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RecipientToken;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RecipientTokenTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RecipientToken::class)]
...
final class RecipientTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RecipientToken.xml',
        );
