...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\RequireThumbprintReferenceTest
 *
 * @package simplesamlphp/xml-ws-security-policy
 */
#[Group('sp')]
#[CoversClass(RequireThumbprintReference::class)]
...
final class RequireThumbprintReferenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/RequireThumbprintReference.xml',
        );
    }
}
