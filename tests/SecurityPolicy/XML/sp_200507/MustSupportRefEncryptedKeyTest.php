...
use SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefEncryptedKey;
...
/**
 * Class \SimpleSAML\WebServices\SecurityPolicy\XML\sp_200507\MustSupportRefEncryptedKeyTest
 *
...
final class MustSupportRefEncryptedKeyTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/sp/200507/MustSupportRefEncryptedKey.xml',
        );
    }
}
